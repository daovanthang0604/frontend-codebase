...
const triggerClass = cn(
  "bg-panel border-gray-a7 text-gray-12 inline-flex h-9 w-full items-center gap-2 rounded-md border px-3 text-left text-sm outline-none transition-[box-shadow,border-color] duration-150",
