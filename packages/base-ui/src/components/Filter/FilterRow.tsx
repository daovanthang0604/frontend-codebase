...
function RemainingBadges({
  ...
  // ui also anchored a hover Tooltip to this badge via triggerRef; Base UI's
  // child-based PopoverTrigger can't share one anchor with a TooltipTrigger, so
  // the richer click-to-open popover (with per-item remove) is kept.
  return (
    <PopoverTrigger isOpen={isOpen} onOpenChange={setIsOpen}>
      <span
        role="button"
