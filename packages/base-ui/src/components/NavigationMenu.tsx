    ...
    <BaseNavigationMenu.Portal>
      ...
      >
        <BaseNavigationMenu.Popup
          className={cn(
            // WDS paper surface, same as the other overlays.
            "bg-panel text-gray-12 relative h-[var(--popup-height)] w-[var(--popup-width)] rounded-lg border shadow-lg outline-none",
