    ...
    <BaseAlertDialog.Portal>
      ...
      <BaseAlertDialog.Popup
        className={cn(
          ...
          "bg-panel fixed top-1/2 left-1/2 z-50 flex max-h-[calc(100dvh-40px)] w-full max-w-[calc(100vw-40px)] -translate-x-1/2 -translate-y-1/2 flex-col gap-4 rounded-2xl p-6 shadow-2xl outline-none md:max-w-md dark:border",
