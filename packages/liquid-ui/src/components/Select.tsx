...
const triggerClassName = cn(
  "bg-panel border-gray-a7 text-gray-12 flex h-9 w-full items-center gap-2 rounded-md border px-3 text-sm transition-[box-shadow,border-color] duration-150 outline-none",
...
// Shared glass surface (glass-overlay) + entrance recipe (same as Popover/Menu overlays). Base UI
...
const popupClassName = cn(
  "glass-overlay text-gray-12 relative min-w-[var(--anchor-width)] rounded-lg outline-none",
      ...
      >
        <BaseSelect.Popup className={cn(popupClassName, className)} {...props}>
          <BaseSelect.ScrollUpArrow
            className={cn(scrollArrowClassName, "top-0")}
          >
            <ChevronUp />
          </BaseSelect.ScrollUpArrow>
