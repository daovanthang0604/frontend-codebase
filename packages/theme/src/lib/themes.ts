...
const liquid: NamedTheme = {
  ...
  material: {
    light: {
      ...
      "--glass-radius": "1.5rem",
      // Fill/tint/shadow tuned UP from the first pass (0.55/0.28 fill, 0.2
      // shadow): over the pale light sky the panels washed out — the surface
      // needs enough body and drop to separate from a near-white backdrop.
      "--glass-fill-top": "rgb(255 255 255 / 0.66)",
      "--glass-fill-bot": "rgb(255 255 255 / 0.4)",
      "--glass-tint-top": "oklch(0.72 0.13 210 / 0.3)",
      "--glass-tint-bot": "oklch(0.72 0.13 210 / 0.12)",
      ...
      "--glass-shadow": "oklch(0.5 0.07 240 / 0.3)",
      "--glass-contact": "oklch(0.5 0.07 240 / 0.22)",
    },
    dark: {
      "--panel": "var(--gray-2)",
